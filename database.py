...
recover_interrupted_application_attempts = _using_default(applications.recover_interrupted_application_attempts)
...
export_user_application_history = _using_default(applications.export_user_application_history)
delete_user_application_history = _using_default(applications.delete_user_application_history)
prune_product_history = _using_default(applications.prune_product_history)

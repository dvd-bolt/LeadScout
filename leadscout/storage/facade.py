...
REPOSITORY_FUNCTIONS = {
    ...
    "record_search_run": applications.record_search_run,
    "list_search_runs": applications.list_search_runs,
    ...
    "recover_interrupted_application_attempts": applications.recover_interrupted_application_attempts,
    ...
    "export_user_application_history": applications.export_user_application_history,
    "delete_user_application_history": applications.delete_user_application_history,
    "prune_product_history": applications.prune_product_history,
    ...
    "recover_interrupted_resume_parsing": resume_drafts.recover_interrupted_resume_parsing,
    ...
    "list_user_operations": operations.list_user_operations,
}

# Архив: план оставшейся реализации LeadScout AI

> Пункты ниже относятся к прежней реализации Taskiq/Redis и сохранены только для истории.
> Актуальная архитектура и проверка описаны в `README.md` и `PROJECT_SPECIFICATION.md`.

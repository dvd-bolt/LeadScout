...
- SQLite v7 добавляет роли, технические задания и административные команды. Миграция v6
  в цепочке обновлений исправляет старые телефонные ключи. При коллизиях миграция останавливается
